(function () {
	...
	*/
	...
	class MyContentComponent extends imba.tags.get('component','ImbaElement') {
		...
		render(){
			...
			$b$0 || ($t$1=imba.createElement('h2',0,$t$0,null,"Content",null));
			$t$0.close$($d$0);
			return $t$0;
		}
	} imba.tags.define('my-content',MyContentComponent,{});

	// ReferenceError: Imba is not defined content.js:1525
	// TypeError: this.setup$ is not a function content.js:780
	// Imba.mount <my-content>
